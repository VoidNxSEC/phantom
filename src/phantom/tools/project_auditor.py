...
from viability_scorer import ViabilityScorer, full_assessment
...
class ProjectAuditor:
    ...
    def _analyze_git(self, path: Path) -> ActivityMetrics:
        ...
        try:
            ...
            if result.returncode == 0 and result.stdout.strip():
                ...
                metrics.days_since_last_commit = (datetime.now(tz=timezone.utc) - last_commit).days
    ...
    def _run_ai_analysis(self, path: Path, metrics: ProjectMetrics) -> Optional[AIInsights]:
